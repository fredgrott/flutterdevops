...
void main() async {
  ...
  runZonedGuarded<Future<void>>(
    () async {
      ...
      Catcher(
        rootWidget: DesignTools(
          verticalInterval: const GuideInterval(16, divisions: 2,),
          horizontalInterval: const GuideInterval(16, divisions: 2,),
          keylines:  const [Keyline(16), Keyline(72), Keyline(16, gravity: KeylineGravity.end,),],
          child: MyApp(
